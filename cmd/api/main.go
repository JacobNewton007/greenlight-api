...
import (
	...
	"github.com/JacobNewton007/greenlight/internal/jsonlog"
...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "e574ff75d71d2c", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "500e99c12fa433", "SMTP password")
